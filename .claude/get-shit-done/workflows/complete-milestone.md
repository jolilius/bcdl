...
```bash
ROADMAP=$(node "/Users/jolilius/home/src/bcdl/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap analyze)
```
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node "/Users/jolilius/home/src/bcdl/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract "$summary" --fields one_liner | jq -r '.one_liner'
done
```
...
```bash
ARCHIVE=$(node "/Users/jolilius/home/src/bcdl/.claude/get-shit-done/bin/gsd-tools.cjs" milestone complete "v[X.Y]" --name "[Milestone Name]")
```
...
**If doesn't exist:** Create from template at `/Users/jolilius/home/src/bcdl/.claude/get-shit-done/templates/retrospective.md`.
...
**Commit:**
```bash
node "/Users/jolilius/home/src/bcdl/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update retrospective for v${VERSION}" --files .planning/RETROSPECTIVE.md
```
...
```bash
INIT=$(node "/Users/jolilius/home/src/bcdl/.claude/get-shit-done/bin/gsd-tools.cjs" init execute-phase "1")
