...
- **Global scope**: `/Users/jolilius/home/src/bcdl/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jolilius/home/src/bcdl/.claude/notes/`)
...
2. Glob `/Users/jolilius/home/src/bcdl/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jolilius/home/src/bcdl/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jolilius/home/src/bcdl/.claude/notes/` — works in any directory
