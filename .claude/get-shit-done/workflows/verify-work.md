...
<template>
@/Users/jolilius/home/src/bcdl/.claude/get-shit-done/templates/UAT.md
</template>
...
```bash
INIT=$(node "/Users/jolilius/home/src/bcdl/.claude/get-shit-done/bin/gsd-tools.cjs" init verify-work "${PHASE_ARG}")
...
Commit the UAT file:
```bash
node "/Users/jolilius/home/src/bcdl/.claude/get-shit-done/bin/gsd-tools.cjs" commit "test({phase_num}): complete UAT - {passed} passed, {issues} issues" --files ".planning/phases/XX-name/{phase_num}-UAT.md"
```
...
- Follow @/Users/jolilius/home/src/bcdl/.claude/get-shit-done/workflows/diagnose-issues.md
